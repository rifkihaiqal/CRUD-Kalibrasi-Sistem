...
if (isset($_GET['equipment'])) {
    ...
    // perintah query untuk menampilkan data foto pegawai berdasarkan 
    $result = $mysqli->query("SELECT foto FROM pegawai WHERE equipment='$equipment'")
    ...
    if ($hapus_file) {
        ...
        $delete = $mysqli->query("DELETE FROM pegawai WHERE equipment='$equipment'")
