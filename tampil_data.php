    <div class="row">
        ...
        // jika alert = 4
        // tampilkan pesan Gagal "equipment sudah ada"
        elseif ($_GET['alert'] == 4) { ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong><i class="fas fa-times-circle"></i> Gagal!</strong> equipment <b><?php echo $_GET['equipment']; ?></b> sudah ada.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    $(document).ready(function() {
        ...
        var table = $('#tabel-pegawai').DataTable( {
            ...
            "columnDefs": [ 
                { "targets": 0, "data": null, "orderable": false, "searchable": false, "width": '10px', "className": 'center' },
                ...
                {
                  "targets": 9, "data": null, "orderable": false, "searchable": false, "width": '80px', "className": 'center',
                  "render": function(data, type, row) {
                      var btn = "<a style=\"margin-right:7px\" title=\"Ubah\" class=\"btn btn-outline-info btn-sm\" href=\"?page=ubah&equipment="+data[ 9 ]+"\"><i class=\"fas fa-edit\"></i></a><span><a title=\"Hapus\" class=\"btn btn-outline-danger btn-sm\" href=\"proses_hapus.php?equipment="+data[ 9 ]+"\"><i class=\"fas fa-trash\"></i></a></span>";
                      return btn;
                  } 
                } 
            ],
